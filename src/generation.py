...
try:
    ...
    def _ollama_absent(*args, **kwargs):
        raise ImportError("ollama n'est pas installé")

    ollama = types.SimpleNamespace(list=_ollama_absent, pull=_ollama_absent, chat=_ollama_absent)
